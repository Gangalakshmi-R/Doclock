    ...
    <div className="app">
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          {currentPage === "chat" && (
            <section className="conversation-sidebar" aria-label="Chat history">
              <div className="conversation-header">
                <div>
                  <span className="conversation-label">AI ASSISTANT</span>
              ...
              <div className="conversation-list">
                {loadingConversations ? (
                  ...
                  <div className="conversation-empty">
                    ...
                    <small>Start a chat to create one.</small>
                  </div>
                ) : (
        ...
        <div className="privacy-box">
          <div className="privacy-title">🔒 Private Vault</div>
          <p>Your documents are stored privately on your system.</p>
        </div>
      </aside>
        ...
        <header className="header">
          <div>
            <p className="header-label">
              {currentPage === "chat" ? "DOCLOCK AI" : "PERSONAL VAULT"}
            </p>
            <h1>
              {currentPage === "chat" ? "Ask your documents" : "My Documents"}
            </h1>
          </div>
          ...
          <section className="content">
            <section className="hero">
              <div className="hero-content">
                <p className="hero-label">YOUR PRIVATE KNOWLEDGE BASE</p>
                <h2>
                ...
                <p className="hero-description">
                  Upload your documents and DocLock will prepare them for
            ...
            <section className="upload-section">
              <div className="section-title">
                ...
                <p>Add a PDF to your personal knowledge base.</p>
              </div>
            ...
            <section className="documents-section">
              <div className="documents-heading">
                <div>
                  ...
                  <p>
                    {documents.length} {documents.length === 1 ? "document" : "documents"} in your vault
                  </p>
                </div>
                <div className="count">{documents.length}</div>
              </div>
                  ...
                  {documents.map((document) => (
                    <article className="document-card" key={document.id}>
                      ...
                      <p className="document-meta">
                        {formatSize(document.fileSize)} • {formatDate(document.uploadedAt)}
                      </p>

                      <div className="status">
                        <span
                          className={`status-dot ${document.status?.toLowerCase() || ""}`}
                        />
                        <span>
